...
function AccessCode() {
    ...
    $.ajax({
        ...
        // 用户信息
        console.log(data);
        userId = data.detail.openid;
        headerImg = data.detail.headimgurl;
...
$(function(){
        ...
        wx.config({
            ...
            timestamp: configData.detail.timestamp, // 必填，生成签名的时间戳
            nonceStr: configData.detail.nonceStr, // 必填，生成签名的随机串
            signature: configData.detail.signature,// 必填，签名，见附录1
